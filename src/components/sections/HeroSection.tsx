        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative z-10">
            ...
            >
              ...
              Physiotherapist, Yoga & Health Science Expert
            </motion.div>
            ...
            >
              Holistic Rehabilitation, Orthopedic Care, Weight Transformation & Women’s Health.
            </motion.p>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-body text-xs">BPT · MPT · Diploma in Yoga & Health Science</p>
                </div>
              </div>
              <div className="hidden sm:block h-8 w-px bg-gray-200" />
              <div className="flex flex-wrap gap-2">
                {['Rehab', 'Weight Mgmt', "Women's Health"].map((spec) => (
                  <span
                    key={spec}
              ...
              <div className="relative aspect-[3/4] rounded-4xl overflow-hidden bg-gradient-to-br from-primary-100 via-teal-50 to-primary-50 shadow-hero border border-white">
                <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-primary-500 text-xs mt-2">5+ Years Experience</p>
                  </div>
                </div>
